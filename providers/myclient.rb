...
def load_current_resource
  ...
  @current_resource.keyname(@new_resource.keyname || "client.#{current_resource.name}")
  @current_resource.caps(get_caps(@current_resource.keyname))
  default_filename = "/etc/ceph/ceph.client.#{@new_resource.name}.#{@new_resource.as_keyring ? 'keyring' : 'secret'}"
